...
public class Subscription {
    ...
    /**
     * Equality for offerings can be established based on their IDs. However, for brevity, neither
     ...
     */
public Set<Offering> offerings;

  /** Presentation aid. */
  @Override
  public String toString() {
    return ToString.fromPublicFields(Subscription.class, this);
  }
}
